...
const SideNav = () => {
    ...
    const toggle = () => {
        if (isCollapsed) {
            ...
            pimg.current.style.display = "block";
            menuName.current.style.display = "block";
            ...
            pimg.current.style.display = 'none';
    ...
    return (
        ...
        <div ref={sidenavRef} className={`darksoul-sidenav ${isCollapsed ? 'collapsed' : ''}`}>
            ...
            <div style={{ display: "flex", width:"100%" ,height:"10svh",alignItems:"center", justifyContent:"center", position:"relative",left:"-5%"}}>
            <p ref={menuName}>Aditya University</p>
            </div>

                <div className="home_menu-container">
                    {['Home', 'Get Bus','Live Track','Issues'].map((menu, index) => (
